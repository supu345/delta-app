  ...
  return (
    <AnimatePresence mode="wait">
      {isOpen && (
        ...
        >
          <div className="text-md font-semibold uppercase bg-gray-400 h-[600px] text-black py-10 mx-6 rounded-3xl">
            <ul className="flex flex-col justify-center items-center gap-10">
              ...
              <li className="group relative cursor-pointer">
                ...
                <div className="absolute right-0 z-50 hidden w-[220px] bg-gray-500 p-2 text-black shadow-md rounded-md group-hover:block">
                  <ul className="space-y-2">
