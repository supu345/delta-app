...
import logo from "../../src/assets/delta1-logo.png";
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="container flex justify-between items-center py-3 px-5">
          {/* Logo section */}
          <Link to="/">
            <div className="text-xl flex items-center gap-2 font-bold">
              ...
              <div className="text-center flex flex-row">
                <p className="text-green-600">The New Delta Apparels Ltd</p>
              </div>
            </div>
          </Link>
          ...
          <div className="hidden lg:block">
            <ul className="flex items-center gap-2">
              ...
              {/* <li className="group relative cursor-pointer ">
                ...
                >
                  About Us
                  <FaCaretDown className="transition-all duration-200 group-hover:rotate-180 mr-4" />
                </Link>
